...
fn main() {
    let input = fs::read_to_string("src/inputs/input.txt").expect("Unable to read from file");
    let input2 = fs::read_to_string("src/inputs/plot.txt").expect("Unable to read from file");
